				...
				<?php  if(!empty($item['styleid'])) { ?>
					<div class="item item-style<?php  if($setting['styleid'] == $item['styleid']) { ?> active<?php  } ?>">
						...
						<div class="title">
							...
							<a href="<?php  echo url('site/uceditor/uc', array('styleid' => $item['styleid']))?>">
								<img src="../app/themes/<?php  echo $item['name'];?>/preview.jpg" class="img-rounded" />
							</a>
						...
						<div class="btn-group  btn-group-justified">
							...
							<a href="javascript:;" onclick="preview('<?php  echo $item['styleid'];?>','<?php  echo $item['url_index'];?>');return false;" class="btn btn-default btn-xs">预览</a>
						</div>
					</div>
				<?php  } else { ?>
...
<script type="text/javascript">
	...
	function preview(styleid,url_index) {
