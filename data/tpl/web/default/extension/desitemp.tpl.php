...
require(['filestyle', 'util'], function($, u){
	...
	$("#form1").submit(function(){
        ...
        var url_index = $.trim($(':text[name="template[url_index]"]').val());
        if(url_index == '' || (/\*\/|\/\*|eval|\$\_/i).test(url_index)) {
            msg += '必须输入有效的模板首页. <br />';
        }
...
<div class="clearfix">
	<form class="form-horizontal form" id="form1" action="" method="post" enctype="multipart/form-data">
		...
		<div class="form-group">
			<label class="col-xs-12 col-sm-2 col-md-2 col-lg-1 control-label">模板首页</label>
			<div class="col-sm-10 col-xs-12">
				<input type="text" class="form-control" placeholder="" name="template[url_index]" value="http://<?php  echo $_SERVER['HTTP_HOST']?>/app/index.php?i=2&c=themes&a=default&do=deindex&" />
				<span class="help-block">模板的首页链接</span>
			</div>
		</div>
		<div class="form-group">
